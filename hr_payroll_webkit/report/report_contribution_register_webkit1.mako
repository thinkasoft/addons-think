    ...
    <table class="basic_table" width="100%">
        <tr>
            ...
            <td style="text-align: left;">
                <strong style="font-size: 20;">${_('Registro de Contribucion CAMBIO') |entity}</strong>
            </td>
       </tr>
    </table>
</head>
<body>
    %for o in objects :
        <br/>
        <br/>
        <center><h2>Registro de Contribucion CAMBIO</h2></center>
        <br/>
        <br/>
        <table class="basic_table" width="100%" align="center" style="text-align:center">
            <tr>
                <td width="40%">
                    <b>${_("Nombre de Contribucion CAMBIO")} </b>
                </td>
                <td width="30%">
                    ${_("Desde")}
                </td>
