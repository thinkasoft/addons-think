            ...
            <table class="basic_table" width="100%">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <strong style="font-size: 20;">DETALLE DE NOMINA</strong>
                    </td>
               </tr>
            </table>
    <% suma1 = 0 %>
    ...
    %endfor
		<table width="100%" style="border:1px solid black;border-collapse:collapse;">
                <tr>
                    ...
                    <td style="border:1px solid black; text-align: center;" width="10%">
                        <FONT FACE="raro, courier" SIZE=1><b>N. Recibo</b></FONT>
                    </td>
	...
	%endfor
		<table width="100%" style="border:1px solid black;border-collapse:collapse;">
                <tr>
                    ...
                    <td style="border:1px solid black; text-align: right;" width="15%">
                        <FONT FACE="raro, courier" SIZE=1><b>${formatLang(suma1)} Bs.</b></FONT>
                    </td>
                    <td style="border:1px solid black; text-align: right;" width="15%">
                        <FONT FACE="raro, courier" SIZE=1><b>${formatLang(suma2)} Bs.</b></FONT>
                    </td>
                    <td style="border:1px solid black; text-align: right;" width="15%">
