...
<table width="100%">
    ...
    %if o.Fecha_Egreso == "False":
        <p style="text-align:justify">Quien suscribe, Alcibiete Ricciardelli, en mi carácter de Gerente de Operaciones de la empresa ${o.company_id.partner_id.name}, por medio de la presente hago constar que los datos abajo suminisrados corresponden a nuestro trabajador(a) ACTIVO</p>
    %else:
        <p style="text-align:justify">Quien suscribe, Alcibiete Ricciardelli, en mi carácter de Gerente de Operaciones de la empresa ${o.company_id.partner_id.name}, por medio de la presente hago constar que los datos abajo suminisrados corresponden a nuestro trabajador(a), quién prestó sus servicios laborales para esta institución: </p>
    %endif
    ...
    <br/>
    <p style="text-align:justify">En caso de necesitar alguna otra información, no dude en comunicarse al 0241 - 871.62.36</p>
