...
<body>
    ...
    %for o in objects :
        ...
        <table width="100%" class="bottomBorder" style="line-height:8pt;">
                <tr> <td style="text-align:left;" /> Total: ${formatLang(total_integral, digits=2)} </td> </tr>
        </table>
        ...
        <table width="100%" style="border:1px solid black;border-collapse:collapse;">
            <tr>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>I.N.C.E.S</FONT> </td>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>${formatLang(inces)}</FONT> </td>
            </tr>
        </table>
        <table width="100%" style="border:1px solid black;border-collapse:collapse;">
            <tr>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>FAOV</FONT> </td>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>${formatLang(faov)}</FONT> </td>
            </tr>
        </table>
        <table width="100%" style="border:1px solid black;border-collapse:collapse;">
            <tr>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>ISRL</FONT> </td>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>${formatLang(isrl)}</FONT> </td>
            </tr>
        </table>
        <table width="100%" style="border:1px solid black;border-collapse:collapse;">
            <tr>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>Prestamo Personal</FONT> </td>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>${o.other_benefits_deductions}</FONT> </td>
            </tr>
        </table>
        <% total_deductions =  inces + faov +  isrl + o.other_benefits_deductions%>
        <table width="100%" style="border:1px solid black;border-collapse:collapse;">
        <tr>
            <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>Total Deducciones</FONT> </td>
            <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>${formatLang(total_deductions)}</FONT> </td>
        </tr>
        </table>
        <% pay_utilites =  result - total_deductions%>
        <table width="100%" style="border:1px solid black;border-collapse:collapse;">
            <tr>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>Utilidades a pagar</FONT> </td>
                <td style="border:1px solid black;" width="10%"> <FONT FACE="raro, courier" SIZE=1>${formatLang(pay_utilites)}</FONT> </td>
            </tr>
        </table>
